...
((banco_pelotas_DX$l083==1 | banco_pelotas_DX$l083a==1) &(banco_pelotas_DX$soma>=3)) & 
...
banco_pelotas_DX$TB <- ifelse(banco_pelotas_DX$TB1==1 | banco_pelotas_DX$TBII==1 | banco_pelotas_DX$TBII.p==1, 1, 0)
#banco com a variavel com os zeros 
library(haven)
banco_pelotas_DX <- read_sav("pelotasDX.sav")
library(dplyr)
...
#### Novo Banco de Dados 
data_rfe <- treino_onda4[,c("TB", "Zkqvambi", "Zkescadol", "Zkfeliz", "Zkqvfisico", "Zkqitotbr", "Zkqvsocial", "ZkSRQdepre_anx",  "Zkibem", "ZkSRQsomatic", "Zkqvpsico", "kinsbai", "alcool_lifetime", "ZkSQRenergia", "ZkSRQsentidepre", "kprobdin", "kansger")]
prop.table(table(data_rfe$TB))
data_testing <- teste_onda4[,c("TB", "Zkqvambi", "Zkescadol", "Zkfeliz", "Zkqvfisico", "Zkqitotbr", "Zkqvsocial", "ZkSRQdepre_anx",  "Zkibem", "ZkSRQsomatic", "Zkqvpsico", "kinsbai", "alcool_lifetime", "ZkSQRenergia", "ZkSRQsentidepre", "kprobdin", "kansger")]
...
###Onda 1 ####
########### Onda 1 #####
treino_onda1 <- train_matrix[,c("TB","histpsiquiatri", "sexonovo", "ahipert", "adiabet", "ainfeccao", "aanemia", "aintern", "afumou", "abebalc", "avivmar", "sexonovo", "aalcool", "Zaidadmae", "Zapesorn","Zacompr", "Zapcrn",  "Zarenfam" 
)]
prop.table(table(treino_onda1$TB))
teste_onda1 <- test_matrix[,c("TB","histpsiquiatri", "sexonovo", "ahipert", "adiabet", "ainfeccao", "aanemia", "aintern", "afumou", "abebalc", "avivmar", "sexonovo", "aalcool", "Zaidadmae", "Zapesorn","Zacompr", "Zapcrn",  "Zarenfam" 
)]
...
set.seed(5627)
ctrl.rf_rose_RF <- trainControl(method="cv", number = 10, classProbs = TRUE,savePredictions = TRUE, summaryFunction = twoClassSummary)
rose_outside_RF_onda1 <- train(TB ~ ., data = rose_train_onda1, method = "rf", trControl = ctrl.rf_rose_RF, tuneGrid=grid.rf, tuneLength = 10, metric = "ROC")
library(beepr)
beep()
library(e1071)
test_pred_rose_RF_onda1 <- predict(rose_outside_RF_onda1, newdata = teste_onda1[,-1])
matrixConfusao_rose_RF_onda1 <- confusionMatrix(test_pred_rose_RF_onda1, teste_onda1$TB, positive = "yes")
matrixConfusao_rose_RF_onda1 
library(caret)
library(pROC)

p_rose_RF_onda1 <- predict (rose_outside_RF_onda1, teste_onda1[,-1])
p_prob_rose_RF_onda1 <- predict (rose_outside_RF_onda1, teste_onda1[,-1], type = "prob")
confusionMatrix(p_rose_RF_onda1, teste_onda1$TB)
print(confusionMatrix(p_rose_RF_onda1, teste_onda1$TB, positive = "yes"))
r_rose_RF_onda1 <- roc (teste_onda1$TB, p_prob_rose_RF_onda1[,"yes"])
plot(r_rose_RF_onda1)
r_rose_RF_onda1$auc
#### onda 2 ####
...
set.seed(5627)
ctrl.rf_rose_RF <- trainControl(method="cv", number = 10, classProbs = TRUE,savePredictions = TRUE, summaryFunction = twoClassSummary)
rose_outside_RF_onda2 <- train(TB ~ ., data = rose_train_onda2, method = "rf", trControl = ctrl.rf_rose_RF, tuneGrid=grid.rf, tuneLength = 10, metric = "ROC")
library(beepr)
beep()
library(e1071)
test_pred_rose_RF_onda2 <- predict(rose_outside_RF_onda2, newdata = teste_onda2[,-1])
matrixConfusao_rose_RF_onda2 <- confusionMatrix(test_pred_rose_RF_onda2, teste_onda2$TB, positive = "yes")
matrixConfusao_rose_RF_onda2 
library(caret)
library(pROC)

p_rose_RF_onda2 <- predict (rose_outside_RF_onda2, teste_onda2[,-1])
p_prob_rose_RF_onda2 <- predict (rose_outside_RF_onda2, teste_onda2[,-1], type = "prob")
confusionMatrix(p_rose_RF_onda2, teste_onda2$TB)
print(confusionMatrix(p_rose_RF_onda2, teste_onda2$TB, positive = "yes"))
r_rose_RF_onda2 <- roc (teste_onda2$TB, p_prob_rose_RF_onda2[,"yes"])
plot(r_rose_RF_onda2)
r_rose_RF_onda2$auc
...
set.seed(5627)
ctrl.rf_rose_RF <- trainControl(method="cv", number = 10, classProbs = TRUE,savePredictions = TRUE, summaryFunction = twoClassSummary)
rose_outside_RF_onda3 <- train(TB ~ ., data = rose_train_onda3, method = "rf", trControl = ctrl.rf_rose_RF, tuneGrid=grid.rf, tuneLength = 10, metric = "ROC")
library(beepr)
beep()
library(e1071)
test_pred_rose_RF_onda3 <- predict(rose_outside_RF_onda3, newdata = teste_onda3[,-1])
matrixConfusao_rose_RF_onda3 <- confusionMatrix(test_pred_rose_RF_onda3, teste_onda3$TB, positive = "yes")
matrixConfusao_rose_RF_onda3 
library(caret)
library(pROC)

p_rose_RF_onda3 <- predict (rose_outside_RF_onda3, teste_onda3[,-1])
p_prob_rose_RF_onda3 <- predict (rose_outside_RF_onda3, teste_onda3[,-1], type = "prob")
confusionMatrix(p_rose_RF_onda3, teste_onda3$TB)
print(confusionMatrix(p_rose_RF_onda3, teste_onda3$TB, positive = "yes"))
r_rose_RF_onda3 <- roc (teste_onda3$TB, p_prob_rose_RF_onda3[,"yes"])
plot(r_rose_RF_onda3)
r_rose_RF_onda3$auc
